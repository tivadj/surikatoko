...
public:
    ...
    void ProcessFrame(size_t frame_ind, bool suppress_observations, int kalman_update_impl);
...
private:
    ...
    void ProcessFrame_OneComponentOfOneObservationPerUpdate(size_t frame_ind, bool suppress_observations);
    ...
    void GetSalientPointData(size_t sal_pnt_ind, SalientPointInternal* result) const;
    ...
    void FiniteDiff_hd_by_camera_state(const SalientPointInternal& sal_pnt,
        Scalar finite_diff_eps,
        Eigen::Matrix<Scalar, kPixPosComps, kCamStateComps>* hd_by_xc) const;
    
    void FiniteDiff_hd_by_sal_pnt_state(size_t obs_sal_pnt_ind, const CameraPosState& cam_state,
        Scalar finite_diff_eps,
