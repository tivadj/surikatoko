...
def TestMatchInConcreteLocation(data_dir):
    ...
    frame0_ind = 0
    img0 = cv2.imread(os.path.join(data_dir, images[frame0_ind]), flags=cv2.IMREAD_GRAYSCALE)
    patch_top_left=Point2i(69,172)
    patch_size=Size2i(17, 17)
    ...
    frame1_ind = 23
    test_top_left = Point2i(72,178)
    img1 = cv2.imread(os.path.join(data_dir, images[frame1_ind]), flags=cv2.IMREAD_GRAYSCALE)
